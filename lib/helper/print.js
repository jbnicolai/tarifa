...
function printLine(/* format, [ args ... ]*/) {
    var args = Array.prototype.slice.call(arguments, 0);
...
function todo(/* format, [ args ... ]*/) {
    var args = Array.prototype.slice.call(arguments, 0);
    util.print(chalk.bgYellow.blue('TODO'), ' ', util.format.apply(this, args), '\n');
}
...
function outline(/* format, [ args ... ]*/) {
    var args = Array.prototype.slice.call(arguments, 0);
    util.print(chalk.yellow.underline(util.format.apply(this, args), '\n'));
}
