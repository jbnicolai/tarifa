...
// Returns the key used to store which parsed tarifa.json & private.json
// attributes are private.
function parsedPrivateKeys() {
    return 'parsedPrivateKeys:cad4f250-6270-11e4-9803-0800200c9a66';
}
...
module.exports = function (dirname, platform, config) {
    ...
    .spread(function (publicSettings, privateSettings) {
        ...
        Object.defineProperty(mergedObj, parsedPrivateKeys(), descriptor);
        return mergedObj;
    })
...
module.exports.parsedPrivateKeys = parsedPrivateKeys;
