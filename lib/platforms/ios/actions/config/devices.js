var Q = require('q'),
    ...
    parseProvisionFile = require('../../../../ios/parse-mobileprovision'),
    downloadProvisioning = require('../../../../ios/nomad/provisioning/download'),
    getDevices = require('../../../../ios/nomad/device/list'),
    addDevice = require('../../../../ios/nomad/device/add'),
    provisioningManager = require('../../../../ios/nomad/provisioning/device'),
    askDeviceName = require('./ask_device_name'),
    askPassword = require('../../../../questions/password');
