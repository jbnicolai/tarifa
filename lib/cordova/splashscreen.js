var copyDefaultAssets = require('./assets').copyDefaultAssets,
    ...
    mapping = {
        ...
        android : [
            ...
            { src: 'screen-640x480.9.png',  dest: 'res/drawable-land-hdpi/screen.9.png' },
            { src: 'screen-426x320.png',    dest: 'res/drawable-land-ldpi/screen.png' },
            { src: 'screen-426x320.9.png',  dest: 'res/drawable-land-ldpi/screen.9.png' },
            { src: 'screen-470x320.png',    dest: 'res/drawable-land-mdpi/screen.png' },
            { src: 'screen-470x320.9.png',    dest: 'res/drawable-land-mdpi/screen.9.png' },
            { src: 'screen-960x720.png',    dest: 'res/drawable-land-xhdpi/screen.png' },
            { src: 'screen-960x720.9.png',    dest: 'res/drawable-land-xhdpi/screen.9.png' },
            { src: 'screen-1410x960.png',   dest: 'res/drawable-land-xxhdpi/screen.png' },
            { src: 'screen-1410x960.9.png',   dest: 'res/drawable-land-xxhdpi/screen.9.png' },
            { src: 'screen-1880x1280.png',  dest: 'res/drawable-land-xxxhdpi/screen.png' },
            { src: 'screen-1880x1280.9.png',  dest: 'res/drawable-land-xxxhdpi/screen.9.png' },
            { src: 'screen-480x640.png',    dest: 'res/drawable-port-hdpi/screen.png' },
            { src: 'screen-480x640.9.png',    dest: 'res/drawable-port-hdpi/screen.9.png' },
            { src: 'screen-320x426.png',    dest: 'res/drawable-port-ldpi/screen.png' },
            { src: 'screen-320x426.9.png',    dest: 'res/drawable-port-ldpi/screen.9.png' },
            { src: 'screen-320x470.png',    dest: 'res/drawable-port-mdpi/screen.png' },
            { src: 'screen-320x470.9.png',    dest: 'res/drawable-port-mdpi/screen.9.png' },
            { src: 'screen-720x960.png',    dest: 'res/drawable-port-xhdpi/screen.png' },
            { src: 'screen-720x960.9.png',    dest: 'res/drawable-port-xhdpi/screen.9.png' },
            { src: 'screen-960x1410.png',   dest: 'res/drawable-port-xxhdpi/screen.png' },
            { src: 'screen-960x1410.9.png',   dest: 'res/drawable-port-xxhdpi/screen.9.png' },
            { src: 'screen-1280x1880.png',  dest: 'res/drawable-port-xxxhdpi/screen.png' },
            { src: 'screen-1280x1880.9.png',  dest: 'res/drawable-port-xxxhdpi/screen.9.png' }
        ],
        wp8 : [
...
module.exports.generateFromFile = function generateFromFile(file, root, platforms, config, verbose) {
    ...
    return rawGenerateFromFile(mapping, file, 'splashscreens', root, nativePlatforms, config, verbose);
};
